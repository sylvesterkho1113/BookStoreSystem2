# BookStoreSystem2
This is a C++ program that demonstrates a bookstore system. There are two modules including admin and customer module.
...
## Steps
Run the code inside the compiler to execute the program
